package com.dawey.duhongwang20180528.widget;
...
import com.dawey.duhongwang20180528.R;
...
/**
 * Created   by   Dewey .
 * 唱片和唱针要求使用组合式自定view的形式，封装成一个自定义Recordview
 */
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (mIsNeed2StartPlayAnimator) {
                    ...
                    if (!mViewPagerIsOffset) {
                        /*延时500ms*/
                        Recordview.this.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                playAnimator();
                            }
