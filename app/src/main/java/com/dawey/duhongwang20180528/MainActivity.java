package com.dawey.duhongwang20180528;
...
import com.dawey.duhongwang20180528.service.MusicService;
import com.dawey.duhongwang20180528.utils.DisplayUtil;
import com.dawey.duhongwang20180528.utils.FastBlurUtil;
import com.dawey.duhongwang20180528.widget.BackgourndAnimationRelativeLayout;
import com.dawey.duhongwang20180528.widget.Recordview;
import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;
import static com.dawey.duhongwang20180528.widget.Recordview.DURATION_NEEDLE_ANIAMTOR;

/**
 *  使用MediaPlayer播放本地音乐
 */
public class MainActivity extends AppCompatActivity implements Recordview.IPlayInfo, View
        .OnClickListener {

    private Recordview mDisc;
    ...
    private void initView() {
        mDisc = (Recordview) findViewById(R.id.discview);
    ...
    //音乐播放进度改变时的设置方法
    @Override
    public void onMusicChanged(Recordview.MusicChangedStatus musicChangedStatus) {
